	...
	<div class="wrapper">
		...
		<img src="../media/images/iUAI.jpg" class="img-fluid" alt="Responsive image">
			...
			<ul class="list-unstyled navbar-nav">
				...
				<li class="nav-item">
					<a href="#" class="nav-link"><i class="fas fa-paste"></i> Pasantias</a>
				</li>

				<li class="nav-item">
					<a href="#" class="nav-link"><i class="fas fa-industry"></i> Empresas</a>
				</li>
          ...
          <div class="col-2"> -->
				...
				<li class=" ml-auto dropdown list-unstyled">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li class="nav-item">
							<a href="#" class="nav-link"><i class="fas fa-user-tie"></i> Mis Pasantias</a>
						</li>
						...
						<li class="nav-item">
							<a href="#" class="nav-link"><i class="fa fa-fw fa-power-off"></i> Cerrar Sesion</a>
						</li>
					</ul>
				</li>
			</nav>
