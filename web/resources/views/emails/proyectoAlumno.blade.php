				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td style="color: #333333; font-family: Arial, sans-serif; font-size: 24px;">
							<b>Estimado {{$user->nombres}} {{$user->apellidoPaterno}}:</b>
						</td>
					</tr>
					<tr>
						<td
							style="padding: 20px 0 30px 0; color: #333333; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
							Le informamos que su proyecto ha sido @if($proyecto->status == 3) objetado @elseif($proyecto->status == 4) aprobado @endif por su profesor.
							<br>
							Puede revisar su feedback en la plataforma de Gestión FIC.
							<br>
