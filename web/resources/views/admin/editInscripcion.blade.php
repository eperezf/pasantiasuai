    ...
    <div class="col-md-9 text-center">
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="#"><button class="btn btn-danger" type="button" data-toggle="modal" data-target="#paso2DestroyCheck">Eliminar</button></a>
        </div>
      </div>
      <!-- Modal Paso 2 Destroy -->
      <div class="modal fade" id="paso2DestroyCheck" tabindex="0" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content"> 
              ...
              <div class="modal-body">
                <p class="text-center">
                  Usted esta a punto de eliminar el paso 2 del alumno: <p class="font-weight-bold">{{$datosPasantias['nombresUsuario']}} {{$datosPasantias['apellidoPaternoUsuario']}} {{$datosPasantias['apellidoMaternoUsuario']}}.</p>
                  <p class="text-center">
        ...
        <div class="btn-group">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="#"><button class="btn btn-danger" type="button" data-toggle="modal" data-target="#paso3DestroyCheck">Eliminar</button></a>
          </div>
        </div>

        <!-- Modal Paso 3 Destroy -->
        <div class="modal fade" id="paso3DestroyCheck" tabindex="0" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
          <form method="post" action="{{route('listadoInscripcion.destroyPaso3', $datosPasantias['idPasantia'])}}">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content"> 
                ...
                <div class="modal-body">
                  <p class="text-center">
                    Usted esta a punto de eliminar el paso 3 del alumno: <p class="font-weight-bold">{{$datosPasantias['nombresUsuario']}} {{$datosPasantias['apellidoPaternoUsuario']}} {{$datosPasantias['apellidoMaternoUsuario']}}.</p>
                    <p class="text-center">
                      Si desea continuar con esta operacion, presione eliminar, de lo contrario, cierre esta ventana.
                    </p>
                  </div>
