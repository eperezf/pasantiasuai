<div class="row justify-content-md-center mb-5">
	<div class="col-md-9 text-center">
		...
		<a class="btn btn-lg btn-outline-@if($statusPaso3=='2' || $statusPaso3=='3')success @elseif($statusPaso3=='1')success @else{{'secondary'}}@endif" href="{{route('inscripcion.3.view')}}"role="button">Paso 3 @if($statusPaso3=='3')<i class="fas fa-check"></i>@elseif($statusPaso3=='1')<i class="fas fa-check"></i>@elseif($statusPaso3=='2')<i class="fas fa-envelope"></i>@else <i class="fas fa-question"></i>@endif</a>
