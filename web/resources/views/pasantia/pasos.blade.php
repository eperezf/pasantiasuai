<div class="row justify-content-md-center mb-5">
	<div class="col-md-9 text-center">
		...
		<a class="btn btn-lg btn-outline-@if($statusPaso3=='2')success @elseif($statusPaso2=='1')warning @else{{'secondary'}}@endif" href="{{route('inscripcion.3.view')}}" role="button">Paso 3 @if($statusPaso3=='2')<i class="fas fa-check"></i>@elseif($statusPaso3=='1')<i class="fas fa-exclamation"></i>@else <i class="fas fa-question"></i>@endif</a>
		<a class="btn btn-lg btn-outline-secondary" href="{{route('inscripcion.4.view')}}" role="button" style="display: none">Paso 4</a>
	</div>
</div>