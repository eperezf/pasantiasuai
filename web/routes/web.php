...
Route::get('/admin/listadoInscripcion/{id}/statusPasantia/{statusPasantia}', 'ListadoInscripcionController@validarPariente')->name('listadoInscripcion.validarPariente')->middleware('auth');
